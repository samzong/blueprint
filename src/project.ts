...
export type ProjectPreset = "pitch" | "briefing" | "prototype-lite" | "prototype-full" | "dossier";
...
const presets = new Set<ProjectPreset>(["pitch", "briefing", "prototype-lite", "prototype-full", "dossier"]);
